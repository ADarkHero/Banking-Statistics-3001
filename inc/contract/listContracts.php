            ...
            <div class="card-header" id="heading<?php echo $i; ?>">
                <h5 class="mb-0">
                    <button class="btn btn-link collapsed full-size-button" data-toggle="collapse" data-target="#collapse<?php echo $i; ?>" aria-expanded="false" aria-controls="collapse<?php echo $i; ?>">
                        <div class="container">
                            <div class="row" >
                                <div class="col-12 col-lg-2"><span class=
                                    <?php
                                    if ($contractAmounts[$key] == 0) {
                                        echo '"text-primary"> INFO';
                                    } else {
                                        echo '"text-danger"> UNPAID';
                                    }
                                    ?></span></div>   
                                <div class="col-12 col-lg-8 cut"><span class=
                                    <?php
                                    if ($contractAmounts[$key] == 0) {
                                        echo '"text-primary">';
                                    } else {
                            ...
                            <div class="col-12 col-lg-2"><span class=
                                ...
                                echo bankNumberFormat($contractAmounts[$key]) . " " . $currency;
                                $leftSum += $contractAmounts[$key];
                                ?>                             
                            </span></div> 
                    </div>    
                </div>         
