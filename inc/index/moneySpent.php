...
function generateProgressBar($timeToPaycheck) {
    ...
    if ($paycheckPercent < 0) {
        $paycheckPercent = 0;
    }
    if ($paycheckPercent > 100) {
        $paycheckPercent = 100;
    }
    ?>
...
function getProgressColor($paycheckPercent) {
    ...
    switch (true) {
        case ($paycheckPercent > 75): $progresscolor = "bg-success";
            break;
        case ($paycheckPercent > 50): $progresscolor = "bg-info";
            break;
        case ($paycheckPercent > 25): $progresscolor = "bg-warning";
            break;
